/* Einmalige Erstbefüllung der products-Tabelle beim ersten Serverstart.
   Ursprung: js/products.js (statisches PRODUCTS-Array der alten Demo).
   Nach dem Seed ist diese Datei nur noch für einen "Reset auf Werkszustand" relevant —
   die Produktverwaltung läuft danach vollständig über die Admin-API/DB. */
const SEED_PRODUCTS = [
